  ...
  void _saveMeter(int index) {
    if (depot.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text("Please select depot.")));
      return;
    }

    if (currentControllers[index].text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Please enter Meter ${index + 1} reading.")),
      );
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        content: Text("Meter ${index + 1} saved successfully."),
      ),
    );
    ...
    return ColoredBox(
      ...
      child: Column(
        children: [
          const CustomHeader(
            title: "METER READING",
            subtitle: "Record Energy Meter Reading",
          ),
          Expanded(
            child: Center(
